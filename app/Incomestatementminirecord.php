...
class Incomestatementminirecord extends Authenticatable
{
    ...
    protected $fillable = [
        'sourceoftransaction', 'descriptionoftransaction', 'typeoftransaction', 'transactionamount', 'dateoftransaction',  'ucret', 'incomerefrenceid'
    ];
