...
use App\Creditsalesdetail;
use App\Customerstatement;
use App\Creditsalessummarry;


class ConfirmcreditsaleController extends Controller
{
...
$userrole =  auth('api')->user()->type;
   ...
   $users = DB::table('creditsalescarts')->where('ucret', $userid)->get();
     //getting the total invoice
     $totallineforinvoice = \DB::table('creditsalescarts')->where('ucret', '=', $userid)->sum('linetotal');
    //  $customer = \DB::table('creditsalescarts')->where('ucret', '=', $userid)->value('customername');
     /// getting the total cost
     $totalcostoftheinvoice = \DB::table('creditsalescarts')->where('ucret', '=', $userid)->sum('totalcostprice');
     $totalprofitoninvoice = \DB::table('creditsalescarts')->where('ucret', '=', $userid)->sum('lineprofit');
     $totalvatoninvoice = \DB::table('creditsalescarts')->where('ucret', '=', $userid)->sum('vatamount');
///neteters
$totalnetsaleswithoutvatinvoice = \DB::table('creditsalescarts')->where('ucret', '=', $userid)->sum('netsalewithoutvat');
$totalnetunitsalewithoutvatinvoice = \DB::table('creditsalescarts')->where('ucret', '=', $userid)->sum('netunitsalewithoutvat');
