...
class Supplierstatement extends Authenticatable
{
    use HasApiTokens, Notifiable;

   
    protected $fillable = [
          'suppliername', 'transactiontype', 'transactiondate', 'description', 'openningbal',
          'amount', 'debitamount', 'ucret', 'resultatantbalance', 'invoiceinaction'    
    ];
