...
/////////////////////////////////////////////////////////////////////////////////////////////
            editexpensecategory(customerdetailsrecords){
                this.editmode = true;
                 this.form.clear();
        this.form.reset();
        this.form.fill(customerdetailsrecords);
...
/// send request ti
if (result.isConfirmed) {
  this.form.delete('api/customerdetailsrecords/'+id).then(()=>{
...
if (result.isConfirmed) {
 ...
 axios.get("api/shopcashoutdetails").then(({ data }) => (this.customerdetailsrecords = data));
...
$('#suppliersModal').modal('show');
 ...
 createNewcustomer(){
                          ...
                          //   this.loading = true,
                                this.form.post('api/addnewcustomerrecord')
                                .then(()=>{
