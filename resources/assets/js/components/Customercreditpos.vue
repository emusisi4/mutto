               ...
               <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                        PROFORMER INVOICE  
                             <div class="mysalessect" style="float:right; margin: 5px;" > 
                         
   <button     @click.prevent="printreceipt" @mouseover="loadlatestReceiptdetails" target="_blank" class="btn bg-brown  waves-effect"> Print Last Proforma </button> 
                    </div>
                   
                     <div class="mysalessect" style="float:right; margin: 5px;" > 
                           <button  class="btn bg-black waves-effect waves-light" data-toggle="modal" data-target="#productreturnsModal"> Add New Invoice </button> 
<button  type="button" class="btn btn bg-deep-orange  waves-effect waves-light" @click="completesale" >Complete  </button>
                    </div>
                            </h2>
...
<!-- <div class="bethapa-table-header"></div> -->
 ...
 <table style="width:100%">
  <thead>
    <tr>
         <th class="tresed">#</th>
      <th class="tresed"> Description of goods</th>
        <th class="tresed"> Quantity</th>
       <th class="tresed">Rate</th>
      <th class="tresed">Unit</th>
      <th class="tresed">Amount</th>
      <th class="tresed"></th>
    </tr>
  </thead>
  <tbody>
      <tr v-for="shobalrecs in creditsalescartdetails.data" :key="shobalrecs.id">
         <td>
      ...
      <span class="book-title"> <template v-if="shobalrecs.unit_measureshopingcat">	{{shobalrecs.unit_measureshopingcat.shotcode}}</template></span>
        ...
        <td> <span class="item-price"> {{currencydetails}}  {{formatPrice(shobalrecs.linetotal)}}</span></td>
          ...
          <button type="button" class="btn btn-danger btn-xs"  @click="removeitemfromcart(shobalrecs.id)"> Del </button>               
                </span></td>
...
<th class="musisialignleft" >Description of goods</th>
<th class="musisialignleft"> Quantity</th>
<th class="musisialignleft"> Rate</th>
<th class="musisialignleft"> Unit</th>

<th class="musisialignleft">  Amount </th>
</tr>
    ...
    <!-- //////////////////////////////////////////////////////////////////// -->
      ...
      <div class="modal fade" id="pruductdetailModal">
         <div class="modal-dialog modal-sm" role="document">
                ...
                <h4  v-show="editmode" class="modal-title" ><img src="images/logo.png" class="profile-user-img img-fluid img-circle" style="height: 80px; width: 80px;">Add Item to Proforma Invoice</h4> 
                        </div>
...
<div class="modal fade" id="productrsseturnsModal">
         <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3  v-show="!editmode"    class="modal-title">
                                <img src="images/logo.png" class="profile-user-img img-fluid img-circle" style="height: 80px; width: 80px;">ADD NEW RECORD</h3> 
                <h4  v-show="editmode" class="modal-title" >UPDATE RECORD</h4> 
                        </div>
                  <form class="form-horizontal" @submit.prevent="editmode ? updateproductCategory():createPrsssddoformainvoice()"> 
...
<div class ="bethapa-table-sectionheader">Product Category</div>
  ...
  <div class="modal fade" id="modaltodisplayPrintinvoice">
         <div class="modal-dialog modal-sm" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h3  v-show="!editmode"    class="modal-title"><img src="images/logo.png" class="profile-user-img img-fluid img-circle" style="height: 80px; width: 80px;">New Product Registration</h3> 
...
<div class ="bethapa-table-sectionheader">Invoice Details</div>
                                ...
                                <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                     <select name ="customername" v-model="form.customername" id ="category" class="form-control-sm show-tick" data-live-search="true"  :class="{'is-invalid': form.errors.has('customername')}">
                    <option value="">   </option>
                    ...
                    <has-error :form="form" field="customername"></has-error>
                                  ...
                                  <div class="row clearfix">
                                    ...
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                     <input v-model="form.invoicesalesdate" type="date" name="invoicesalesdate"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('invoicesalesdate') }">
                    <has-error :form="form" field="invoicesalesdate"></has-error>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Customer Order No.</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
                                                     <input v-model="form.customerorderno" type="text" name="customerorderno"
                      class="form-control" :class="{ 'is-invalid': form.errors.has('customerorderno') }">
                    <has-error :form="form" field="customerorderno"></has-error>
                                            </div>
                                        </div>
                                    </div>
                                </div>
...
methods:{
  ...
  createProformainvoice(){
      this.$Progress.start();
        this.form.post('api/generatenewcreditsale')
        .then(()=>{
   ...
   axios.get("api/customercontact").then(({ data }) => (this.customercontact = data));
...
{
   this.$Progress.start();
this.form.post('api/insertintoproformacart')
...
if (result.isConfirmed) {
   this.form.post('api/confirmsaleoncredit').then(()=>{
...
/// send request ti
if (result.isConfirmed) {
  this.form.delete('api/creditsalescartdetails/'+id).then(()=>{
