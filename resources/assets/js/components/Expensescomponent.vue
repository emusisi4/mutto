...
<tr>
          <tr v-for="expcat in expensecategorydetails.data" :key="expcat.id">
                      ...
                      <td>{{(expcat.created_at)}}</td>
                        ...
                        <div class="bethapa-table-header"  >  Expense Types </div>
...
<div class="mysalessect"> 
  <input type="text" placeholder="Enter Expense name " v-model="expenseslistsearch" v-on:keyup="searchformadeexpense" @keyup="searchformadeexpense" class="formcont2">
                ...
                <ul class="pagination pagination-sm m-0 float-right">
                   <pagination :data="allowedrolecomponentsObject" @pagination-change-page="paginationroleAuthorisedsubmenues"></pagination>
                                ...
                                <div role="tabpanel" class="tab-pane fade" id="settings">
                                   ...
                                   <div class="bethapa-table-header"  >  Company Expenditures   
    <button type="button"  class="add-newm" @click="newofficeexpenditure" >Make Expense</button>
...
<div class="modal fade" id="makeofficeexpensemodal">
        ...
        <div  class="modal-content">
            ...
            <h3  v-show="!editmode"    class="modal-title"><img src="images/logo.png" class="profile-user-img img-fluid img-circle" style="height: 80px; width: 80px;">Expense Request Form</h3> 
                <h4  v-show="editmode" class="modal-title" ><img src="images/logo.png" class="profile-user-img img-fluid img-circle" style="height: 80px; width: 80px;">Update Expense Request </h4> 
                        </div>
   ...
   <div class="row clearfix">
                                    <div class="col-lg-2 col-md-2 col-sm-4 col-xs-5 form-control-label">
                                        <label for="email_address_2">Expense Date</label>
                                    </div>
                                    <div class="col-lg-10 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
                                            <div class="form-line">
...
methods:{
searchformadeexpense: _.debounce(() => {
        Fire.$emit('searchingforexpense');
      },1000),
...
// end of global details
 ...
 Fire.$on('searchingforexpense', ()=>{
            ...
            let query = this.expenseslistsearch;
          //   axios.get("api/productpriceslist").then(({ data }) => (this.productpriceslist = data));
 axios.get('api/findExpensefromexpenseslist?q='+ query)
 .then((data)=> {
this.datarecordscompanyexpenses = data.data;
 })
 .catch(()=>{
