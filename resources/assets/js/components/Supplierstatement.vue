...
Supplier Statement Report  : From  {{salesreportsatartingdate}} to {{salesreportendingdate}}
</div>
...
<tr>
          <tr v-for="prodcates in supplierstatementrecords.data" :key="prodcates.id">
              <td>{{prodcates.id }}</td>
...
savecustomerstatementFilter(){
  ...
  axios.get("api/supplierstatementrecords").then(({ data }) => (this.supplierstatementrecords = data));
