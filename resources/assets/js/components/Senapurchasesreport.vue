...
<div v-if="generalProductscomponentAccess > 0 " > 
 ...
 <div  class="col-lg-3 col-md-3 col-sm-6 col-xs-4">
                    <div class="info-box bg-indigo">
                        ...
                        <div class="content">
                            <div class="text"><b>PURCHASES COST  </b></div>
                            <div class="number count-to" data-from="0" data-to="257" data-speed="1000" data-fresh-interval="20">
                              <b>{{currencydetails}}  {{formatPrice(totaldailypurchasesordersrangereports)}}</b></div>
                        </div>
                    </div>
                </div>
 ...
 <div  class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-indigo">
                        ...
                        <div class="content">
                            <div class="text"><b>DELIVERY AMOUNTS   </b></div>
                            <div class="number count-to" data-from="0" data-to="257" data-speed="1000" data-fresh-interval="20">
                              <b>{{currencydetails}}  {{formatPrice(totaldailypurchasesdeliveriesamountrangereports)}}</b></div>
                        </div>
                    </div>
                </div>
               ...
               <div  class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-indigo">
                        ...
                        <div class="content">
                            <div class="text"><b>PAID VAT </b></div>
                            <div class="number count-to" data-from="0" data-to="257" data-speed="1000" data-fresh-interval="20">
                              <b>{{currencydetails}}  {{formatPrice(totaldailypurchasesvatsrangereports)}}</b></div>
                        </div>
                    </div>
                </div>
<!-- v-if="outputcomponentaccess > 0 " -->
       <div  class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-indigo">
                        <div class="icon">
                            <i class="material-icons"></i>
                        ...
                        <div class="content">
                            <div class="text"><b>PAYMENTS MADE </b></div>
                            <div class="number count-to" data-from="0" data-to="257" data-speed="1000" data-fresh-interval="20"
                            >   <b>{{currencydetails}}  {{formatPrice(totaldailypurchasespaymentsamountrangereports) }}</b></div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
                    <div class="info-box bg-indigo">
                        ...
                        <div class="content">
                            <div class="text"><b>PENDING PAYMENTS </b></div>
                            <div class="number count-to" data-from="0" data-to="257" data-speed="1000"
                             data-fresh-interval="20"><b>{{formatPrice(totaldailypurchasespaymentsbalancerangereports)}}</b></div>
                        </div>
                    </div>
                </div>
</div>
    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                            <h2>
                         SENNAH HARDWARE   PURCHASES REPORTS
                            </h2>
...
Daily Purchases Detailed Report : From - To - 
</div>
...
<!-- <div class="mysalessect">  -->
 ...
 <form @submit.prevent="savedatestoViewpurchasesreportsreport()">
                 
                      <div class="form-group">

                                        <label>Start Date</label>
  <input v-model="form.startdate" type="date" name="startdate" id="startdate" v-on:change="tosubmitPurchasessssfilter" >

      <label>End Date</label>
  <input v-model="form.enddate" type="date" name="enddate" id="enddate" v-on:change="tosubmitPurchasessssfilter" > 
                              
             <button type="submit" style="display:none" id="submit" hidden="hidden" name= "submit" ref="buttontosubmitpurchasesFilter" class="btn btn-primary btn-sm">Saveit</button>         
...
<table  class="musisireporttable" width="100%" border="1">
       <tr>
             ...
             <th colspan="1"  style="font-size: 18px;     border-bottom: 4px solid rgb(124 102 102);     background-color: rgb(29 31 34 / 37%); color: #131378;"> ORDER DATE</th>
            ...
            <th colspan="3"  style="font-size: 18px; text-align:center;    
             ...
             <th colspan="2"  style="font-size: 18px; text-align:center;    
               border-bottom: 4px solid rgb(124 102 102);     background-color: rgb(29 31 34 / 37%); color: #131378;"> TOTAL PAYMENTS</th>
...
<tr>
          ...
          <tr v-for="prodcates in dailypurchasesreportsummaryrecords.data" :key="prodcates.id">
             <td>{{prodcates.id  }}</td>
                               ...
                               <td><div class="musisialignright"> {{formatPrice(prodcates.deliveredamount)}} </div></td>                   
                                ...
                                <td><div class="musisialignright">  {{formatPrice(prodcates.paymentsmade)}} </div></td>
                                
                               <td><div class="musisialignright">  {{formatPrice(prodcates.balanceonpayments)}} </div></td>
...
Purchases report Summary by Invoice : From - To - 
</div>
...
<!-- <div class="mysalessect">  -->
    <div> 
          ...
          <!-- <div class="mysalessect">  -->
           <div class="mysalessect2"> 
 <form @submit.prevent="savedatestoViewpurchasesreportsreportprodsummary()">
                 
                      <div class="form-group">

                                        <label>Start Date</label>
  <input v-model="form.startdate" type="date" name="startdate" id="startdate" v-on:change="tosubmitProductsummaryinv" >

      <label>End Date</label>
  <input v-model="form.enddate" type="date" name="enddate" id="enddate" v-on:change="tosubmitProductsummaryinv" > 

   <label>Supplier</label>

                                              <select name ="suppliername"  v-model="form.suppliername" v-on:change="tosubmitProductsummaryinv" id ="suppliername"  class="show-tick" data-live-search="true"  :class="{'is-invalid': form.errors.has('suppliername')}">
             ...
             <button type="submit" style="display:none" id="submit" hidden="hidden" name= "submit" ref="buttontosubmitProductsummaryinv" class="btn btn-primary btn-sm">Saveit</button>         
...
<table  class="musisireporttable" width="100%" border="1">
       <tr>
            ...
            <th colspan="3"  style="font-size: 18px; text-align:center;    
             ...
             <th colspan="2"  style="font-size: 18px; text-align:center;    
               border-bottom: 4px solid rgb(124 102 102);     background-color: rgb(29 31 34 / 37%); color: #131378;"> PAYMENTS</th>
             <th colspan="1"  style="font-size: 18px;     border-bottom: 4px solid rgb(124 102 102);     background-color: rgb(29 31 34 / 37%); color: #131378;"> </th>
...
<tr>
          <tr v-for="prodcates in dailypurchasesreportdetailedrecords.data" :key="prodcates.id">
             <td>{{prodcates.purchaseno  }}</td>
                               ...
                               <td><div class="musisialignright">  {{formatPrice(prodcates.amountpaid)}} </div></td>
                                  ...
                                  <td><div class="musisialignright"> {{formatPrice(prodcates.invoicebalance)}} </div></td>
...
<table  class="musisireporttable" width="100%" border="1">
       <tr>
             ...
             <th colspan="1"  style="font-size: 18px;  
              ...
              <th colspan="1"  style="font-size: 18px;  
                border-bottom: 4px solid rgb(124 102 102);     background-color: rgb(29 31 34 / 37%); color: #131378;"> ITEM</th>
...
<tr>
          ...
          <tr v-for="prodcates in productpurchasesdetailrecords.data" :key="prodcates.id">
             <td>{{prodcates.invoiceno  }}</td>
                                 ...
                                 <td>{{prodcates.dateordered | myDate2 }}</td>
...
salessummaryComponentaccess:'',
       ...
       ////////////////////////////////////////////////////////////////////////////////////
          ...
          dailysalessummaryrecords:{},
           ...
           dailypurchasesreportsummaryrecords:{},
...
totaldailypurchasesordersrangereports :{},
totaldailypurchasesvatsrangereports:{},
totaldailypurchasesdeliveriesamountrangereports:{},
totaldailypurchasesdeliveriesvatsrangereports:{},
...
// gettheinvoicedate
 ...
 savedatestoViewpurchasesreportsreportprodsummary(){
...
axios.get("api/totaldailypurchasesdeliveriesamountrangereports").then(({ data }) => (this.totaldailypurchasesdeliveriesamountrangereports = data));
axios.get("api/totaldailypurchasesdeliveriesvatsrangereports").then(({ data }) => (this.totaldailypurchasesdeliveriesvatsrangereports = data));

axios.get("api/totaldailypurchasespaymentsamountrangereports").then(({ data }) => (this.totaldailypurchasespaymentsamountrangereports = data));
axios.get("api/totaldailypurchasespaymentsbalancerangereports").then(({ data }) => (this.totaldailypurchasespaymentsbalancerangereports = data));
                                // Toast.fire({
                                // icon: 'success',
                                // title: 'Record Added Successfully'
                                // });
 ...
 savedatestoViewpurchasesreportsreport(){
...
tosubmitProductsummaryinv($event) { const elem = this.$refs.buttontosubmitProductsummaryinv
            elem.click()
        },
...
tosubmitPurchasessssfilter($event) { const elem = this.$refs.buttontosubmitpurchasesFilter
            elem.click()
        },
