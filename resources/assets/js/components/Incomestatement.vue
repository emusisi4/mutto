                            ...
                            <ul class="nav nav-tabs" role="tablist">
                                ...
                                <li role="presentation" class="active" v-if="categoriesComponentaccess > 0">
                                    <a href="#home_with_icon_title" @click="loadProductcategories()" data-toggle="tab">
                                        <i class="material-icons"></i> Income statement Summary report
                                    </a>
                                </li>
...
<th style="font-size: 18px; text-align:center;    
               border-top: 4px solid rgb(124 102 102);    
                background-color: rgb(211 211 211); color: #131378;" >
<div class="musisialignright"> {{currencydetails}} {{formatPrice(totalsalesforincomestatement)}} </div>
</th>
...
<th style="font-size: 18px; text-align:center;    
               border-top: 4px solid rgb(124 102 102);    
                background-color: rgb(211 211 211); color: #131378;" >
<div class="musisialignright"> {{currencydetails}} {{formatPrice(totalcostforincomestatement)}} </div>
</th>

<th style="font-size: 18px; text-align:center;    
               border-top: 4px solid rgb(124 102 102);    
                background-color: rgb(211 211 211); color: #131378;" >
<div class="musisialignright"> {{currencydetails}} {{formatPrice(totalgrossprofitincomestatement)}} </div>
</th>
...
<th style="font-size: 18px; text-align:center;    
               border-top: 4px solid rgb(124 102 102);    
                background-color: rgb(211 211 211); color: #131378;" >
<div class="musisialignright"> {{currencydetails}} {{formatPrice(totalotherincomesforincomestatement)}} </div>
</th>
...
<th style="font-size: 18px; text-align:center;    
               border-top: 4px solid rgb(124 102 102);    
                background-color: rgb(211 211 211); color: #131378;" >
<div class="musisialignright"> {{currencydetails}} {{formatPrice(totalexpensesforincomestatement)}} </div>
</th>
...
totalsalesforincomestatement:{},
totalcostforincomestatement:{},
totalgrossprofitincomestatement:{},
totalotherincomesforincomestatement:{},
totalexpensesforincomestatement:{},
totalnetprofitbeforothertaxesforincomestatements:{},
...
axios.get('/api/totalsalesforincomestatement').then(function (response) { this.totalsalesforincomestatement = response.data;}.bind(this));

axios.get('/api/totalcostforincomestatement').then(function (response) { this.totalcostforincomestatement = response.data;}.bind(this));
axios.get('/api/totalgrossprofitincomestatement').then(function (response) { this.totalgrossprofitincomestatement = response.data;}.bind(this));
axios.get('/api/totalotherincomesforincomestatement').then(function (response) { this.totalotherincomesforincomestatement = response.data;}.bind(this));

axios.get('/api/totalexpensesforincomestatement').then(function (response) { this.totalexpensesforincomestatement = response.data;}.bind(this));
axios.get('/api/totalnetprofitbeforothertaxesforincomestatements').then(function (response) { this.totalnetprofitbeforothertaxesforincomestatements = response.data;}.bind(this));
